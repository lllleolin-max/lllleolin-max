...
| :--- | :--- | :--- |
| **[Prettier](https://github.com/prettier/prettier)** | Preserve comment order in test calls · 修复测试调用中的注释顺序 | [🟣 #20043](https://github.com/prettier/prettier/pull/20043) |
| **[Pillow](https://github.com/python-pillow/Pillow)** | Correct `ImageOps.crop` border type hints · 修正边框类型注解与文档 | [🟣 #9989](https://github.com/python-pillow/Pillow/pull/9989) |
| **[AIBrix](https://github.com/vllm-project/aibrix)** | Fix JSON message examples for the chat tokenizer · 修正聊天 tokenizer 示例 | [🟣 #2713](https://github.com/vllm-project/aibrix/pull/2713) |
| **[VitePress](https://github.com/vuejs/vitepress)** | Fix page spacing when no sidebar is present · 修复无侧栏时的页面间距 | [🟣 #5430](https://github.com/vuejs/vitepress/pull/5430) |
...
<sub>Upstream contributions only; PRs in my own repositories are excluded. Verified September 14, 2026.</sub>
