<img src="assets/profile-banner.png" alt="lllleolin-max — Exploring AI-assisted open source" width="100%">

<p>
  <img src="https://img.shields.io/badge/Model-GPT--6--Astra-35665C?style=flat-square&labelColor=292F32" alt="Model: GPT-6-Astra">
  <img src="https://img.shields.io/badge/Reasoning-Ultra-35665C?style=flat-square&labelColor=292F32" alt="Reasoning depth: Ultra">
</p>

### AI-assisted contributions · AI 协作说明

I'm exploring AI-assisted code maintenance and pull requests as part of evaluating **my own research project**. I use **GPT-6-Astra** with **Ultra** reasoning. **All code changes I submit undergo human review.**

我正在尝试使用 AI 进行代码维护和提交 PR，这也是对**自己研究项目**的实际检验。使用模型为 **GPT-6-Astra**，思考深度为 **Ultra**；**所有提交的代码变更均经过人工审核**。
...
<p>
  <a href="https://github.com/search?q=is%3Apr+is%3Amerged+author%3Alllleolin-max+-user%3Alllleolin-max&type=pullrequests"><img src="https://img.shields.io/badge/Merged_PRs-11-35665C?style=for-the-badge&labelColor=292F32" alt="11 merged upstream pull requests"></a>
  <img src="https://img.shields.io/badge/Upstream_projects-4-35665C?style=for-the-badge&labelColor=292F32" alt="4 upstream projects with merged contributions">
</p>
...
<td width="50%" valign="top">
  <img src="assets/vitepress.svg" width="36" height="36" alt="VitePress logo">
  <h3><a href="https://github.com/vuejs/vitepress">VitePress</a></h3>
  <p><strong>8 merged PRs</strong> · Documentation tooling</p>
  <p>Page layout, links, content loading and hot updates.<br>页面布局、链接处理、内容加载与热更新。</p>
  <a href="https://github.com/vuejs/vitepress/pulls?q=is%3Apr+is%3Amerged+author%3Alllleolin-max">Explore contributions →</a>
</td>
<td width="50%" valign="top">
  <img src="assets/prettier.png" width="36" height="36" alt="Prettier logo">
  <h3><a href="https://github.com/prettier/prettier">Prettier</a></h3>
  <p><strong>1 merged PR</strong> · Code formatting</p>
  <p>Preserve comment order in test calls.<br>修复测试调用中的注释顺序。</p>
  <a href="https://github.com/prettier/prettier/pull/20043">Read the contribution →</a>
</td>
</tr>
<tr>
<td width="50%" valign="top">
  <img src="assets/pillow.png" width="36" height="36" alt="Pillow logo">
  <h3><a href="https://github.com/python-pillow/Pillow">Pillow</a></h3>
  <p><strong>1 merged PR</strong> · Python imaging</p>
  <p>Correct <code>ImageOps.crop</code> type hints and docs.<br>修正边框类型注解与文档。</p>
  <a href="https://github.com/python-pillow/Pillow/pull/9989">Read the contribution →</a>
</td>
<td width="50%" valign="top">
  <img src="assets/aibrix.jpeg" height="36" alt="AIBrix logo">
  <h3><a href="https://github.com/vllm-project/aibrix">AIBrix</a></h3>
  <p><strong>1 merged PR</strong> · Inference infrastructure</p>
  <p>Fix JSON message examples for the chat tokenizer.<br>修正聊天 tokenizer 的 JSON 示例。</p>
...
<details>
<summary><strong>Explore all 11 merged PRs · 展开完整贡献记录</strong></summary>
...
<sub>Only merged upstream PRs are counted; my own repositories and unmerged PRs are excluded. Verified September 14, 2026.<br>仅统计已合并的对外贡献，不含个人仓库及未合并 PR。核验日期：2026 年 9 月 14 日。</sub>
